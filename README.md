...
|1.3.0-final|Current version. [More...](./docs/api_1.3.0-final.md)|
...
|/decide/ | POST        |1.3.0-final|Returns a 'decision' on Employment Status for Tax Purposes (current version). [More...](./docs/api_1.3.0-final.md)|
